...
JNIEXPORT jstring JNICALL Java_android_tether_usb_system_NativeTask_getProp
...
JNIEXPORT jint JNICALL Java_android_tether_usb_system_NativeTask_runCommand
